...
This konnector retrieves your declarations from [autoentrepreneur.urssaf.fr](https://www.autoentrepreneur.urssaf.fr/) for Micro/Auto Entrepreneur
...
The lead maintainers for this konnector is Laurent Morel
...
Auto-Entrepreneur is developed by Laurent Morel and distributed under the [AGPL v3 license][agpl-3.0].

Thanks
------
Thanks to @Schoumy for the original konnector (its artworks and useful descriptions) :)
